    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <P>
          ...
          no <Text style={{ fontWeight: 700, color: BLACK }}>alAi</Text>, o sistema que reúne num só lugar a
          Solicitação de Compras, Viagens Acerto, Facilities e o cardápio de Cadastro, Contratos de
          Fornecedores e NDA. A ideia é
        ...
        <Bullet><Text style={{ fontWeight: 700 }}>Linha do Orçamento</Text>: escolha <Text style={{ fontWeight: 700 }}>Orçamento Extra</Text> quando não há linha prevista, ou <Text style={{ fontWeight: 700 }}>Outros</Text> para digitar o nome da linha manualmente. Ao escolher Orçamento Extra, abre-se uma tela pedindo o valor e sua base (mensal, anual ou total), a vigência, se o impacto é recorrente ou pontual, e o motivo de o valor não estar previsto. É esse detalhamento que a Coordenação ou o Gerente F&NC vai ler para decidir a exceção. Não é preciso anexar comprovante: a aprovação fica registrada no próprio sistema.</Bullet>
