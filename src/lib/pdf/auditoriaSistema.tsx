  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Bullet><Text style={styles.cardLabel}>Orçamento Extra: </Text>escolher a opção abre um detalhamento obrigatório (valor e base, vigência, impacto recorrente ou pontual, motivo), exigido também pela API. O anexo de validação do FP&amp;A deixou de ser obrigatório em 21/08/2026: a aprovação da exceção é registrada em BudgetException, pela Coordenação ou pelo Gerente F&amp;NC conforme a alçada.</Bullet>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Finding n={8} severity="regra" situacao="resolvido" comoFoiResolvido="resolvido por outro caminho, e o achado deixou de existir junto com a regra. A cobrança do anexo chegou a ser fechada em quatro pontos de API, mas a exigência inteira foi RETIRADA em 21/08/2026, por decisão do dono do sistema: o anexo era o print de um e-mail em que o FP&A aprovava o gasto, prova externa porque o sistema não tinha prova própria. Passou a ter. O solicitante detalha valor, base, vigência, impacto e motivo num modal na abertura, exigido pela API e não só pela tela, e a Coordenação ou o Gerente F&NC decide a exceção dentro do sistema, com nível, decisão, autor, justificativa e data gravados em BudgetException. O registro da aprovação virou o próprio banco. O que protege o gasto hoje é QUEM pode decidir, cobrado por papel conforme a alçada, não a existência de um arquivo. O anexo continua aceito, opcional. Oito casos travam a ausência de cobrança nos cinco pontos, para a regra não voltar sozinha." title="Anexo obrigatório do Orçamento Extra só é exigido na tela">
